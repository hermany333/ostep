...
8010506d:	58                   	pop    %eax
8010506e:	5a                   	pop    %edx
8010506f:	68 f8 78 10 80       	push   $0x801078f8
...
80105088:	68 f7 78 10 80       	push   $0x801078f7
