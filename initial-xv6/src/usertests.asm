...
00000e60 <sharedfd>:
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eec:	68 8c 4e 00 00       	push   $0x4e8c
     ef1:	6a 01                	push   $0x1
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fca:	68 60 4e 00 00       	push   $0x4e60
     fcf:	6a 01                	push   $0x1
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fe4:	68 ac 4e 00 00       	push   $0x4eac
     fe9:	6a 01                	push   $0x1
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete ok\n");
    ...
    13f8:	57                   	push   %edi
    13f9:	68 d8 4e 00 00       	push   $0x4ed8
    13fe:	6a 01                	push   $0x1
...
000015d0 <linktest>:
{
  ...
  printf(1, "linktest ok\n");
    ...
    175b:	52                   	push   %edx
    175c:	52                   	push   %edx
    175d:	68 44 4f 00 00       	push   $0x4f44
    1762:	6a 01                	push   $0x1
    ...
    17a7:	50                   	push   %eax
    17a8:	50                   	push   %eax
    17a9:	68 1c 4f 00 00       	push   $0x4f1c
    17ae:	6a 01                	push   $0x1
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate ok\n");
    ...
    1a8b:	51                   	push   %ecx
    1a8c:	51                   	push   %ecx
    1a8d:	68 68 4f 00 00       	push   $0x4f68
    1a92:	6a 01                	push   $0x1
...
00001d20 <subdir>:
{
  ...
  printf(1, "subdir ok\n");
    ...
    21b3:	53                   	push   %ebx
    21b4:	53                   	push   %ebx
    21b5:	68 0c 50 00 00       	push   $0x500c
    21ba:	6a 01                	push   $0x1
    ...
    21d9:	53                   	push   %ebx
    21da:	53                   	push   %ebx
    21db:	68 7c 50 00 00       	push   $0x507c
    21e0:	6a 01                	push   $0x1
    ...
    2225:	52                   	push   %edx
    2226:	52                   	push   %edx
    2227:	68 c4 4f 00 00       	push   $0x4fc4
    222c:	6a 01                	push   $0x1
    ...
    2238:	50                   	push   %eax
    2239:	50                   	push   %eax
    223a:	68 58 50 00 00       	push   $0x5058
    223f:	6a 01                	push   $0x1
    ...
    224b:	50                   	push   %eax
    224c:	50                   	push   %eax
    224d:	68 34 50 00 00       	push   $0x5034
    2252:	6a 01                	push   $0x1
    ...
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    22bf:	68 e8 4f 00 00       	push   $0x4fe8
    22c4:	6a 01                	push   $0x1
    ...
    22e3:	50                   	push   %eax
    22e4:	50                   	push   %eax
    22e5:	68 9c 4f 00 00       	push   $0x4f9c
    22ea:	6a 01                	push   $0x1
    ...
    2342:	51                   	push   %ecx
    2343:	51                   	push   %ecx
    2344:	68 a0 50 00 00       	push   $0x50a0
    2349:	6a 01                	push   $0x1
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26dc:	68 c0 50 00 00       	push   $0x50c0
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26f9:	68 10 51 00 00       	push   $0x5110
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 80 51 00 00       	push   $0x5180
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    274b:	68 1c 52 00 00       	push   $0x521c
  ...
  printf(1, "fourteen ok\n");
    ...
    2783:	50                   	push   %eax
    2784:	50                   	push   %eax
    2785:	68 3c 52 00 00       	push   $0x523c
    278a:	6a 01                	push   $0x1
    ...
    2796:	52                   	push   %edx
    2797:	52                   	push   %edx
    2798:	68 ec 51 00 00       	push   $0x51ec
    279d:	6a 01                	push   $0x1
    ...
    27a9:	51                   	push   %ecx
    27aa:	51                   	push   %ecx
    27ab:	68 b0 51 00 00       	push   $0x51b0
    27b0:	6a 01                	push   $0x1
    ...
    27bc:	51                   	push   %ecx
    27bd:	51                   	push   %ecx
    27be:	68 40 51 00 00       	push   $0x5140
    27c3:	6a 01                	push   $0x1
    ...
    27cf:	50                   	push   %eax
    27d0:	50                   	push   %eax
    27d1:	68 e0 50 00 00       	push   $0x50e0
    27d6:	6a 01                	push   $0x1
...
00002970 <dirfile>:
{
  ...
  printf(1, "dir vs file OK\n");
    ...
    2b08:	53                   	push   %ebx
    2b09:	53                   	push   %ebx
    2b0a:	68 90 52 00 00       	push   $0x5290
    2b0f:	6a 01                	push   $0x1
    ...
    2b2e:	50                   	push   %eax
    2b2f:	50                   	push   %eax
    2b30:	68 70 52 00 00       	push   $0x5270
    2b35:	6a 01                	push   $0x1
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test OK\n");
    ...
    2d28:	50                   	push   %eax
    2d29:	50                   	push   %eax
    2d2a:	68 b0 52 00 00       	push   $0x52b0
    2d2f:	6a 01                	push   $0x1
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    308b:	50                   	push   %eax
    308c:	53                   	push   %ebx
    308d:	68 a4 53 00 00       	push   $0x53a4
    ...
    30a2:	56                   	push   %esi
    30a3:	56                   	push   %esi
    30a4:	68 d4 52 00 00       	push   $0x52d4
    ...
    30d0:	51                   	push   %ecx
    30d1:	51                   	push   %ecx
    30d2:	68 74 53 00 00       	push   $0x5374
    ...
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 4c 53 00 00       	push   $0x534c
    ...
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 14 53 00 00       	push   $0x5314
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    3310:	c7 04 85 80 a5 00 00 	movl   $0x53c8,0xa580(,%eax,4)
    3317:	c8 53 00 00 
...
00003580 <uio>:
{
  ...
  printf(1, "uio test done\n");
    ...
    35ca:	52                   	push   %edx
    35cb:	52                   	push   %edx
    35cc:	68 a8 54 00 00       	push   $0x54a8
    35d1:	6a 01                	push   $0x1
    ...
    398c:	89 d1                	mov    %edx,%ecx
{
  ...
  neg = 0;
    ...
    3a21:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3a28:	00 
    ...
    3a39:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  ap = (uint*)(void*)&fmt + 1;
    ...
    3a56:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3a5d:	00 
  ...
  write(fd, &c, 1);
    ...
    3b66:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3b6d:	00 
  ...
  write(fd, &c, 1);
    ...
    3bb3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
          s = "(null)";
    3bb8:	ba 79 4d 00 00       	mov    $0x4d79,%edx
        while(*s != 0){
